...
@Config(name = MonkeySMPGraveyard.MOD_ID)
public class MonkeySMPGraveyardConfig implements ConfigData {
	public static MonkeySMPGraveyardConfig getConfig() {
		return AutoConfig.getConfigHolder(MonkeySMPGraveyardConfig.class).getConfig();
	}
